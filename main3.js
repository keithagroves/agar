(function (h, r) {
    ...
    function ea() {
        ...
        r.get("http://m.agar.io/info", function (a) {
            for (var b in a.regions) r('#region option[value="' +
                    b + '"]')
                .text(S[b] + " (" + a.regions[b].numPlayers + " players)")
        }, "json")
    }
    ...
    function ya(a) {
        ...
        for (;;) {
            ...
            c += 8;
            a.getUint8(c++);
            for (var h = a.getUint8(c++), l = a.getUint8(c++), k = a.getUint8(c++), h = (h << 16 | l << 8 | k)
            ...
            n.nSize = g;
            n.updateCode = b;
            n.updateTime = E; - 1 != C.indexOf(e) && -1 == m.indexOf(n) && (document.getElementById("overlays")
                .style.display = "none", m.push(n), 1 == m.length && (s = n.x, t = n.y))
        }
        a.getUint16(c, !0);
        c += 2;
        f = a.getUint32(c, !0);
        ...
        if (0 != w.length)
            if (V) {
                ...
                for (b = 0; b < w.length; ++b) c = w[b].name || "An unnamed cell", V || (c = "An unnamed cell"), -1 != C.indexOf(w[b].id) ? (m[0].name && (c = m[0].name), a.fillStyle = "#FFAAAA") : a.fillStyle = "#FFFFFF", c = b + 1 + ". " +
                    c, a.fillText(c, 100 - a.measureText(c)
                        .width / 2, 70 + 24 * b)
            } else z = null
    }
        ...
        oa.prototype = {
            ...
            draw: function () {
                if (this.shouldRender()) {
                    ...
                    ra ? -1 != Ea.indexOf(a) ? (W.hasOwnProperty(a) || (W[a] = new Image, W[a].src = "skins/" + a + ".png"), b = W[a]) : b = null : b = null;
                    ...
                    sa && b && (null == this.sizeCache && (this.sizeCache = new U(this.getNameSize() / 2, "#FFFFFF", !0, "#000000")), b = this.sizeCache, b.setSize(this.getNameSize() / 2), b.setValue(~~(this.size * this.size / 100)), c = Math.ceil(10 * g) / 10, b.setScale(c),
